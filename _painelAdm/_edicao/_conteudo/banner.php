    ...
    <div class="col-md-12">
        <div class="form-group" style="width: 900px">								
            ...
            <div class="item active">
                <?php foreach($imagensSite AS $imagem): ?>
                    ...
                    <form role="form" method="post" action="_conteudo/_php/atualizar-banner.php?etapa=2&idImagem=<?php echo $imagem['idImagem']; ?>">
                        ...
                        <a href="_conteudo/_php/atualizar-banner.php?etapa=3&idImagem=<?php echo $imagem['idImagem']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Excluir </a>
                    </form>
                <?php endforeach; ?>
            </div>							
        </div>
        ...
        <div class="form-group" style="width: 900px">
            <form enctype="multipart/form-data" role="form" method="post" action="_conteudo/_php/atualizar-banner.php?etapa=1">
                <div class="form-group">
                    <label class="control-label" for="exampleInputEmail1">&nbsp;Título da Imagem:</label>
                    <input class="form-control" id="tituloImagem"	name="tituloImagem" placeholder="Digite o título desejado" type="text" >
                </div>
                <div class="form-group">
                    <label class="control-label" for="exampleInputEmail1">Descrição da Imagem:</label>
                    <textarea class="form-control" id="dsImagem" name="dsImagem" placeholder="Digite a descrição desejada" rows="4" cols="50"></textarea>
                </div>
                <div class="form-group">								
